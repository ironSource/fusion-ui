...
import {ListBoxModes, StyleVersion, VersionService} from '@ironsource/fusion-uifusion-ui';
...
const MOCK_DATA_0 = [
    ...
    {id: 2, displayText: 'Sammy Lawson'},
    {id: 3, displayText: 'Arina Belomestnykh'},
    {id: 4, displayText: 'Mar Rueda'},
    {id: 5, displayText: 'Sung Jin-Shil'},
    {id: 6, displayText: 'Sibabalwe Rubusana'}
];
...
@Component({
    selector: 'fusion-list-box-docs-v2',
    templateUrl: './list-box-docs-v2.component.html',
    styleUrls: ['./list-box-docs-v2.component.scss']
})
export class ListBoxDocsV2Component implements OnInit, OnDestroy {
    ...
    campaignList = new FormControl(MOCK_DATA_0);

    itemsList = new FormControl(MOCK_DATA_1);
    ...
    ngOnInit() {
        ...
        this.selectedVersion$.subscribe((styleVersion: StyleVersion) => {
            if (styleVersion === StyleVersion.V1) {
                this.router.navigate(['docs/components/list-box']);
            }
        });
