...
var TabsComponent = /** @class */ (function (_super) {
    ...
    function TabsComponent(page, selector) {
    ...
    TabsComponent.prototype.isTabDisabled = function () {
        return __awaiter(this, void 0, void 0, function () {
            var disabledTestId, disabledTab;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        disabledTestId = (0, utils_1.getTestId)(consts_1.defaultTestId, entities_1.TabsTestIdModifiers.TAB_DISABLED);
                        return [4 /*yield*/, this.waitForComponent({ testId: disabledTestId })];
                    case 1:
                        _a.sent();
                        return [4 /*yield*/, this.getByTestId(disabledTestId)];
                    case 2:
                        disabledTab = _a.sent();
                        return [2 /*return*/, disabledTab.isDisabled()];
                }
            });
        });
    };
