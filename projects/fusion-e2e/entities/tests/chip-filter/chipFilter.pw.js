...
(0, test_1.test)('should work when clicked', function () { return __awaiter(void 0, void 0, void 0, function () {
    var labelText;
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0: return [4 /*yield*/, chipFilterPage.goto()];
            ...
            case 2:
                _a.sent();
                return [4 /*yield*/, chipFilterPage.getChipFilterLabel()];
            case 3:
                labelText = _a.sent();
                (0, test_1.expect)(labelText).toBe('Status');
                return [2 /*return*/];
        }
    });
}); });
