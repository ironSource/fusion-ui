...
var consts_1 = require("../components/chart/consts");
...
var ChartPage = /** @class */ (function (_super) {
    __extends(ChartPage, _super);
    function ChartPage(page) {
        var _this = this;
        var chartProps = {
            page: page,
            testId: consts_1.labelTestId,
            componentId: consts_1.chartStoryId,
            loadedPageSelector: consts_1.loadedPageSelector
        };
        _this = _super.call(this, chartProps) || this;
    ...
    ChartPage.prototype.goto = function (gotoParams) {
        ...
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        componentParams = __assign({ testId: consts_1.labelTestId }, gotoParams.additionalComponentParams);
    ...
    ChartPage.prototype.waitForComponent = function () {
        return __awaiter(this, void 0, void 0, function () {
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, this.chart.waitForComponent({ testId: this.testId })];
                    case 1:
                        _a.sent();
                        return [2 /*return*/];
                }
    ...
    ChartPage.prototype.getLabelText = function () {
        return __awaiter(this, void 0, void 0, function () {
            return __generator(this, function (_a) {
                return [2 /*return*/, this.chart.getLabelText({ testId: this.testId })];
            });
        });
    };
    return ChartPage;
