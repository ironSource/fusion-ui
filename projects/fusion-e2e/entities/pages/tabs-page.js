...
var consts_1 = require("../components/tabs/consts");
...
var TabsPage = /** @class */ (function (_super) {
    ...
    function TabsPage(page) {
        ...
        var tabsProps = {
            page: page,
            testId: consts_1.wrapperTestId,
            componentId: consts_1.tabsStoryId,
            loadedPageSelector: consts_1.loadedPageSelector
        };
        _this = _super.call(this, tabsProps) || this;
        _this.tabs = new tabs_component_1.TabsComponent(page, _this.testId);
        return _this;
    }
    TabsPage.prototype.waitForComponent = function () {
        return __awaiter(this, void 0, void 0, function () {
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, this.tabs.waitForComponent({ testId: this.testId })];
                    case 1:
                        _a.sent();
                        return [2 /*return*/];
                }
    ...
    TabsPage.prototype.getSelectedTabText = function () {
    ...
    TabsPage.prototype.isTabDisabled = function () {
