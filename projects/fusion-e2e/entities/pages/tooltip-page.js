...
exports.TooltipPage = void 0;
var consts_1 = require("../components/tooltip/consts");
...
var TooltipPage = /** @class */ (function (_super) {
    ...
    function TooltipPage(page) {
        var _this = this;
        var tooltipProps = {
            page: page,
            testId: consts_1.defaultTestId,
            componentId: consts_1.tooltipStoryId,
            loadedPageSelector: consts_1.loadedPageSelector
        };
        _this = _super.call(this, tooltipProps) || this;
        _this.tooltip = new tooltip_component_1.TooltipComponent(page, _this.testId);
        return _this;
    }
    TooltipPage.prototype.waitForComponent = function () {
        return __awaiter(this, void 0, void 0, function () {
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, this.tooltip.waitForComponent({ testId: this.testId, modifiers: entities_1.TooltipTestIdModifiers.TRIGGER })];
                    case 1:
                        _a.sent();
                        return [2 /*return*/];
                }
        ...
        return __awaiter(this, arguments, void 0, function (gotoParams) {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 1:
                        _a.sent();
                        return [4 /*yield*/, this.openTooltip()];
                    case 2:
                        _a.sent();
    ...
    TooltipPage.prototype.getTooltipText = function () {
        return this.tooltip.getTooltipText({ testId: this.testId });
    };
    TooltipPage.prototype.getTooltipHeaderText = function () {
        return this.tooltip.getTooltipHeaderText({ testId: this.testId });
    };
    TooltipPage.prototype.openTooltip = function () {
        return __awaiter(this, void 0, void 0, function () {
            var tooltipTriggerSelector;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        tooltipTriggerSelector = this.page.getByTestId((0, utils_1.getTestId)(this.testId, entities_1.TooltipTestIdModifiers.TRIGGER));
                        return [4 /*yield*/, tooltipTriggerSelector.hover()];
                    case 1:
                        _a.sent();
                        return [2 /*return*/];
                }
