...
describe('ShortNumberScaleSuffixPipe', () => {
    ...
    it('format number 0.003 to short string "0.00 with precision: 3"', () => {
        const pipe = new ShortNumberScaleSuffixPipe();
        expect(pipe.transform(0.003, {precision: 3})).toBe('0.00');
    });

    it('format number 0.3 to short string "0.30 with precision: 3"', () => {
        const pipe = new ShortNumberScaleSuffixPipe();
        expect(pipe.transform(0.3, {precision: 3})).toBe('0.30');
    });
    it('format number 0.3 to short string "0.30 with precision: 3"', () => {
        const pipe = new ShortNumberScaleSuffixPipe();
        expect(pipe.transform(1.3, {precision: 3})).toBe('1.30');
    });
    ...
    it('format number 123000 to short string "123 K" with precision', () => {
        const pipe = new ShortNumberScaleSuffixPipe();
        expect(pipe.transform(123000, {precision: 3})).toBe('123 K');
    });
    it('format number 764230.2680279986 to short string "764K"', () => {
        const pipe = new ShortNumberScaleSuffixPipe();
        expect(pipe.transform(764230.2680279986, {precision: 3})).toBe('764 K');
    });
    ...
    it('format number 23500 to short string "23.5 K"', () => {
        const pipe = new ShortNumberScaleSuffixPipe();
        expect(pipe.transform(23500,{precision: 3})).toBe('23.5 K');
    });
