...
// todo: check action data for methods
const actionsData = {
    dynamicChipSelect: action('dynamicChipSelect')
};
...
<div style="height: 350px;">
    ...
    >
        ...
        @for (chip of selectedDynamicFilters; track chip){
    ...
    render: args => ({
        props: {
            ...
            dynamicChipSelect: selected => {
                console.log('dynamicChipSelect', selected);
            },
...
export const WithDynamicPreselected: Story = {
    render: args => ({
        props: {
            addFiltersTitle: 'Add filter by:',
            addFilterOptions: [
