...
// region OnePreselectedNotClosable
export const OnePreselectedNotClosable = FilterPanelDefaultTemplate.bind({});
OnePreselectedNotClosable.args = {
    fcChip1: new FormControl(),
    configChip1: {id: 1, mode: 'static', close: true},
    optionsChip1: MOCK_DUMMY_OPTIONS,
    placeholderPrefixChip1: 'Label 1',
...
OnePreselectedNotClosable.parameters = {
    docs: {
        source: {
            language: 'typescript',
            code: dedent`
...
const FilterPanelTemplate: Story<ChipFiltersComponent> = (args: ChipFiltersComponent) => ({
    props: {...args},
    template: `
<div style="height: 350px;">
    <fusion-chip-filters
...
// region WithAddButton
export const WithAddButton = FilterPanelTemplate.bind({});
WithAddButton.args = {
...
// region Add Button
const FilterAddButtonTemplate: Story<ChipFiltersComponent> = (args: ChipFiltersComponent) => ({
    props: {...args},
    template: `
<div style="height: 350px;">
    <fusion-chip-filters
...
export const AddButton = FilterAddButtonTemplate.bind({});
AddButton.args = {
    // region Add Filter Chip props
    addFiltersTitle: 'Add filter by:',
    addFilterOptions: [
...
// region Add Button Disabled
export const AddButtonDisabled = FilterAddButtonTemplate.bind({});
AddButtonDisabled.args = {
    // region Add Filter Chip props
    addFiltersTitle: 'Add filter by:',
    addFilterOptions: [
        {id: 4, displayText: 'Country'},
...
// region NoAddButton
const FilterPanelNoAddTemplate: Story<ChipFiltersComponent> = (args: ChipFiltersComponent) => ({
    props: {...args},
    template: `
<div style="height: 350px;">
    <fusion-chip-filters>
...
export const NoAddButton = FilterPanelNoAddTemplate.bind({});
NoAddButton.args = {
    // region first chip - User
    fcChip1: new FormControl(),
    configChip1: {id: 1, mode: 'static', close: true},
