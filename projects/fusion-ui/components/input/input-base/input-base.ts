import {InputParameters} from '@ironsource/fusion-ui/components/input/input-base/input-parameters';
...
@Directive()
export abstract class InputBase extends InputParameters implements OnInit, OnDestroy, AfterViewInit, ControlValueAccessor {
