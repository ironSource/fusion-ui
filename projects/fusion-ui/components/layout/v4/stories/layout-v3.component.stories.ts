...
const meta: Meta<LayoutStoryWrapperComponent> = {
    ...
    parameters: {
        docs: {
            description: {
                component: dedent`***Layout v3*** description will be here`
            },
            story: {
                inline: false,
                iframeHeight: 600
...
const templateDefault = `<fusion-layout-story-wrapper [headerContent]="headerContent" [layoutConfiguration]="layoutConfiguration"/>`;
