...
<Canvas>
    <div class="row">
        <dov class="col-3"><Story id="components-alert--small" /></dov>
        <dov class="col-3"><Story id="components-alert--small-success" /></dov>
        <dov class="col-3"><Story id="components-alert--small-warning" /></dov>
        <dov class="col-3"><Story id="components-alert--small-error" /></dov>
    </div>
</Canvas>
