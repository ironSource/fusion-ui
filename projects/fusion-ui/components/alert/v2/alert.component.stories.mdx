...
<Canvas>
    <div className="row">
        <div className="col-3"><Story id="components-alert--small" /></div>
        <div className="col-3"><Story id="components-alert--small-success" /></div>
        <div className="col-3"><Story id="components-alert--small-warning" /></div>
        <div className="col-3"><Story id="components-alert--small-error" /></div>
    </div>
</Canvas>
