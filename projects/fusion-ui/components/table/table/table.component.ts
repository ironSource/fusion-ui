...
@Component({
    ...
    styleUrls: ['./table.component.scss', './table.component-v2.scss'],
    changeDetection: ChangeDetectionStrategy.OnPush,
    providers: [TableService]
})
export class TableComponent extends FusionBaseComponent implements OnInit, OnChanges {
    @Input() id: string;
    ...
    configIconNames$ = new Observable<TableIconsConfigByStyle>();
    ...
    ngOnInit() {
        ...
        this.configIconNames$ = this.selectedVersion$.pipe(
            map((styleVersion: StyleVersion) => CONFIG_TABLE_BY_UI_STYLE[`style_v${styleVersion}`])
        );
