...
// region MaxWidth column
export const MaxWidth = TableEditTemplate.bind({});
MaxWidth.args = {
...
export const Currency = TableEditTemplate.bind({});
Currency.args = {
...
export const Percent = TableEditTemplate.bind({});
Percent.args = {
