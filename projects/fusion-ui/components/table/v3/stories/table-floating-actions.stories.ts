...
// region Multiple Row Actions (Floating Actions)
...
export const DisabledAllForSomeRows = TableTemplate.bind({});
DisabledAllForSomeRows.args = {
    options: {
        ...TABLE_DEFAULT_OPTIONS,
...
DisabledAllForSomeRows.parameters = {
    docs: {
        description: {
            story: dedent`
...
// region Multiple Row Actions (Floating Actions) disabled for some rows
export const DisabledSomeActionsForSomeRows = TableTemplate.bind({});
DisabledSomeActionsForSomeRows.args = {
    options: {
        ...TABLE_DEFAULT_OPTIONS,
...
DisabledSomeActionsForSomeRows.parameters = {
    docs: {
        description: {
            story: dedent`
