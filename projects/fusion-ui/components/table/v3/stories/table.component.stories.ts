...
FloatingActionsDisabledForSomeRows.parameters = {
    docs: {
        description: {
            story: dedent`
...
// region Multiple Row Actions (Floating Actions) disabled for some rows
export const SomeFloatingActionDisabledForSomeRows = TableTemplate.bind({});
SomeFloatingActionDisabledForSomeRows.args = {
    options: {
        ...TABLE_DEFAULT_OPTIONS,
