...
**<a href="https://phosphoricons.com/" target="_blank">Phosphor</a>** (v2.0.0) provides a set of commonly used interface icons you can use in your project.
...
**Phosphor icons** use name prefix "ph".
